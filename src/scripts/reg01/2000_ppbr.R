# src/scripts/reg01/2000_ppbr.R
# 
# This script runs regression 1 with `persons_per_bedroom` as the outcome variable
...
output_path <- glue("throughput/reg01/{year}_ppbr.rds")
